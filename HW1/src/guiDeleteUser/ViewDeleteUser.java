 ...
 * @author Enci Zheng
 * 
 * @version 1.00		2025-09-19 Initial version
 *  
 */
...
public class ViewDeleteUser {
	...
	*/
	...
	// Area 2b: When a user has been selected, the delete button are shown and can be used
	...
	protected static Label label_CurrentInfo = new Label("This user's current information:");
	//todo: display the user's information
	//to let admin know if the user is still associated with this class or not
	...
	protected static String theSelectedUser = "";	// The user whose roles are being deleted
	...
	*/
	 ...
	 * the Delete page to be displayed.
	 * 
	 ...
	 * 
	 * @param user specifies the User who will be deleted
	 *
	 */
	...
	public ViewDeleteUser() {
    	...
    	.addListener((ObservableValue<? extends String> observable, 
    		String oldvalue, String newValue) -> {ControllerDeleteUser.doSelectUser();});
		
		// GUI Area 2b
		setupButtonUI(button_Delete, "Dialog", 16, 150, Pos.CENTER, 460, 205);
		ViewDeleteUser.button_Delete.setOnAction((event) -> 
	...
	*/
	...
	/**
	 * Helper method for refreshing combo box whenever
	 */
	protected static void refreshComboBox() {
