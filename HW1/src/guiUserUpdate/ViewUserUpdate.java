...
/**
 * todo:
 * 		implement update password and validate password input
 */
...
public class ViewUserUpdate {
	...
	private static TextInputDialog dialogUpdatePassword;	//added update password dialogue
	...
	private ViewUserUpdate() {
		...
		dialogUpdatePassword = new TextInputDialog("");	//initialize update password popup window
