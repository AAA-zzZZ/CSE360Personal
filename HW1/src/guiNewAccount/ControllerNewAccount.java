...
public class ControllerNewAccount {
	...
	*/
	...
	protected static void doCreateUser() {
		...
		ViewNewAccount.label_UsernameInvalidLabel.setText("");
		ViewNewAccount.label_PasswordInvalidLabel.setText("");
		...
		if(userNameRecognizerErr.length()!=0)
		{
			...
			ViewNewAccount.label_UsernameInvalidLabel.setText(userNameRecognizerErr);
		}
		...
		else if(passwordEvaluationErr.length()!=0)
		{
			...
			ViewNewAccount.label_PasswordInvalidLabel.setText(passwordEvaluationErr);
		}
