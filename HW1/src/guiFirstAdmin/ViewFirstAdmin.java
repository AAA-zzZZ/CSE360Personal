...
public class ViewFirstAdmin {
	...
	private ViewFirstAdmin() {
		...
		setupLabelUI(label_UsernameInvalidLabel, "Arial", 18, width, Pos.CENTER, 0, 300);
		
		// Label to display the Password Invalid error message
		setupLabelUI(label_PasswordInvalidLabel, "Arial", 18, width, Pos.CENTER, 0, 300);
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				text_AdminPassword2, button_AdminSetup, label_UsernameInvalidLabel,
				label_PasswordInvalidLabel, label_PasswordsDoNotMatch, button_Quit);
	}
