...
public class View {
	...
	public static void view (Pane theRoot) {
		...
		setupLabelWidget(validPassword, 10, 370, "Arial", 18, windowWidth-150-10, 
				Pos.BASELINE_LEFT);
		...
		setupButtonWidget(button_Finish, "Finish and Save The Password", (windowWidth-250)/2,
				410, "Arial", 14, 250, Pos.BASELINE_CENTER);
	...
	static protected void resetAssessments() {
	    ...
	    label_ShortEnough.setText("No more than thirty two characters - Not yet satisfied");
