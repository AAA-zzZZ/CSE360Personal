...
public class ViewAddRemoveRoles {
	...
	*/
	...
	// GUI Area 4: This is last of the GUI areas. It contains warnings/pop up windows, 
	// showing user the problems of the selections. 
	protected static Alert alertRemoveOnlyRole = new Alert(AlertType.INFORMATION);
	protected static Alert alertRemoveAdminRole = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	public ViewAddRemoveRoles() {
		...
		button_AddRole.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
		...
		button_RemoveRole.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
	...
	*/
	...
	public static void setTheUser(User theUser) {
		ViewAddRemoveRoles.theUser = theUser;
	}
	...
	public static void setTheStage(Stage theStage) {
		ViewAddRemoveRoles.theStage = theStage;
	}
}
