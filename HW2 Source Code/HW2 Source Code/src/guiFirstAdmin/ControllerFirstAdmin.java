...
public class ControllerFirstAdmin {
	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
		...
		passwordEvaluationErr = ModelInputValidator.checkForValidPassword(adminPassword1); 
		...
		else if(passwordEvaluationErr.length()!=0)
		{
			...
			ModelInputValidator.displayPasswordErrorMessages(ViewFirstAdmin.text_AdminPassword1.getText());
