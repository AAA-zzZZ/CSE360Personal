...
public class ViewAdminHome {
	...
	*/
	...
	protected static Label label_PageTitle2 = new Label();
	...
	protected static Label label_NumberofOneTimePasswordRequests = 
			new Label("Number of One-Time Password Requests: x"); 
	...
	protected static Alert alertDeleteAdmin = new Alert(AlertType.INFORMATION);
	protected static Alert alertNoUserRequestedResetPasswordAlert = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	public static void displayAdminHome(Stage ps, User user) {
		...
		//theAdminHomeScene.setFill(Color.web("#003166"));
	...
	private ViewAdminHome() {
		...
		setupButtonUI(button_UpdateThisUser, "Dialog", 17, 170, Pos.CENTER, 610, 45);
		...
		setupLabelUI(label_NumberofOneTimePasswordRequests, "Arial", 20, 200, Pos.BASELINE_RIGHT, 400, 105);
		label_NumberofOneTimePasswordRequests.setText("Number of one-time password requests: "+
				theDatabase.getNumberOfResetPasswordRequest());
		...
		// GUI Area 4
		setupButtonUI(button_ManageInvitations, "Dialog", 16, 260, Pos.CENTER, 20, 270);
		button_ManageInvitations.setOnAction((event) -> 
			{ControllerAdminHome.manageInvitations(); });
		button_ManageInvitations.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
	
		setupButtonUI(button_SetOnetimePassword, "Dialog", 12, 260, Pos.CENTER, 20, 320);
		button_SetOnetimePassword.setOnAction((event) -> 
			{ControllerAdminHome.setOnetimePassword(); });
		button_SetOnetimePassword.setStyle("-fx-font: 19 arial; -fx-base: #8C1D40;");

		setupButtonUI(button_DeleteUser, "Dialog", 16, 260, Pos.CENTER, 20, 370);
		button_DeleteUser.setOnAction((event) -> {ControllerAdminHome.deleteUser(); });
		button_DeleteUser.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");

		setupButtonUI(button_ListUsers, "Dialog", 16, 260, Pos.CENTER, 20, 420);
		button_ListUsers.setOnAction((event) -> {ControllerAdminHome.listUsers(); });
		button_ListUsers.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");

		setupButtonUI(button_AddRemoveRoles, "Dialog", 15, 260, Pos.CENTER, 20, 470);
		button_AddRemoveRoles.setOnAction((event) -> {ControllerAdminHome.addRemoveRoles(); });
		button_AddRemoveRoles.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
		...
		setupButtonUI(button_Quit, "Dialog", 18, 250, Pos.CENTER, 530, 540);
		...
		theRootPane.getChildren().addAll(
    		...
    		label_NumberOfInvitations, label_NumberOfUsers, label_NumberofOneTimePasswordRequests,
    		line_Separator2,
    		label_Invitations, 
