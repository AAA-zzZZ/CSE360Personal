...
public class ViewUserUpdate {
	...
	static Stage theStage;				// The Stage that JavaFX has established for us	
	private static Pane theRootPane;			// The Pane that holds all the GUI widgets
	static User theUser;				// The current user of the application
	...
	private ViewUserUpdate() {
        ...
        button_UpdateUsername.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
       
        // password
        setupLabelUI(label_Password, "Arial", 18, 190, Pos.BASELINE_RIGHT, 5, 150);
        setupLabelUI(label_CurrentPassword, "Arial", 18, 260, Pos.BASELINE_LEFT, 200, 150);
        setupButtonUI(button_UpdatePassword, "Dialog", 18, 275, Pos.CENTER, 500, 143);
        button_UpdatePassword.setOnAction((event) -> {ControllerUserUpdate.updatePassword(); });
		button_UpdatePassword.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
        ...
        button_UpdateFirstName.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
        ...
        button_UpdateMiddleName.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
        ...
        button_UpdateLastName.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
        ...
        button_UpdatePreferredFirstName.setStyle("-fx-font: 19 arial; -fx-base: #8C1D40;");
        ...
        button_UpdateEmailAddress.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
        ...
        button_ProceedToUserHomePage.setStyle("-fx-font: 22 arial; -fx-base: #FFC627;");
