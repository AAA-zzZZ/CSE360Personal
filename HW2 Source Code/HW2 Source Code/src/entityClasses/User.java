...
public class User {
	...
	public String toString() {
		return "User [userName=" + userName + ", password=" + password + ", firstName=" + firstName + ", middleName="
				+ middleName + ", lastName=" + lastName + ", preferredFirstName=" + preferredFirstName
				+ ", emailAddress=" + emailAddress + ", adminRole=" + adminRole + ", role1=" + role1 + ", role2="
				+ role2 + "]";
	}
    ...
    public User(String userName, String firstName, String middleName, String lastName, String preferredFirstName,
			String emailAddress) {
		super();
		this.userName = userName;
