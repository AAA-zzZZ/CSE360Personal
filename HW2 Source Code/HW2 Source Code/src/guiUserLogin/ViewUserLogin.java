...
public class ViewUserLogin {
	...
	protected static Alert alertUserDoesntExistError = new Alert(AlertType.INFORMATION);
	
	protected static Alert alertOnetimePasswordRequested= new Alert(AlertType.INFORMATION);
	protected static Alert alertOnetimePasswordNotSet = new Alert(AlertType.INFORMATION);
	protected static Alert alertPasswordReset = new Alert(AlertType.INFORMATION);
	
	//labels for invalid inputs
	protected static Label label_UsernameInvalidLabel  = new Label();
	protected static Label label_PasswordInvalidLabel = new Label();

	//	private User user;
	protected static TextField text_Username = new TextField();
	protected static TextField text_ForgetPasswordUsername = new TextField();
	protected static PasswordField text_Password = new PasswordField();
	private static Button button_Login = new Button("Log In");	
	
	//One-Time Password labels and buttons
	private static Label label_forgotPassword = new Label("Forgot Password? Enter your username to request a one-time password");  //++++++
	private static Button button_requestOneTimePass = new Button("Request One-Time Password");
	...
	public static void displayUserLogin(Stage ps) {
		...
		text_ForgetPasswordUsername.setText("");
	...
	private ViewUserLogin() {
		...
		button_Login.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
		
		
		//+++++ set up the Forgot Password Button
        
        setupButtonUI(button_requestOneTimePass, "Dialog", 18, 200, Pos.BASELINE_LEFT, 475, 455);
        button_requestOneTimePass.setOnAction((event) -> {ControllerUserLogin.doRequestOnetimePass(); });
        button_requestOneTimePass.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;"); 
		
		// Label to display the Username Invalid error message
		setupLabelUI(label_UsernameInvalidLabel, "Arial", 18, width, Pos.CENTER, 0, 240);
				
		// Label to display the Password Invalid error message
		setupLabelUI(label_PasswordInvalidLabel, "Arial", 18, width, Pos.CENTER, 0, 240);
		
		alertUsernamePasswordError.setTitle("Invalid username/password!");
		alertUsernamePasswordError.setHeaderText(null);
		
		alertUserDoesntExistError.setTitle("User does not exist!");
		alertUserDoesntExistError.setHeaderText(null);
		
		
		alertOnetimePasswordRequested.setTitle("Request Success");
		alertUsernamePasswordError.setHeaderText(null);
		
		
		alertOnetimePasswordNotSet.setTitle("Password not reset yet");
		alertUserDoesntExistError.setHeaderText(null);

		alertPasswordReset.setTitle("Password already Resetted");
		alertUsernamePasswordError.setHeaderText(null);
		
		
		//The label to request a one-time passcode portion of the page +++++
        setupLabelUI(label_forgotPassword, "Arial", 18, width, Pos.BASELINE_LEFT, 20, 420);
        setupTextUI(text_ForgetPasswordUsername, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 455, true);
        text_ForgetPasswordUsername.setPromptText("Enter Username "); 
		...
		button_SetupAccount.setStyle("-fx-font: 22 arial; -fx-base: #8C1D40;");
		...
		theRootPane.getChildren().addAll(
                ...
                label_LogInInsrtuctions, label_AccountSetupInsrtuctions, text_Username, label_UsernameInvalidLabel,
                button_Login, text_Password, text_Invitation, button_SetupAccount, label_forgotPassword, text_ForgetPasswordUsername, button_requestOneTimePass,
                button_Quit); 
	}
